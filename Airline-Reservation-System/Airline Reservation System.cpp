...
//adult-RM1000
//kid-RM500
/*1. CANADA (adult = adult, kid = kid / per person)
  2. Bangkok (adult = +100, kid = +50 / per person)
  3. NEW YORK (adult = +200, kid = +100 / per person)
		...
		{	cout<<"\n========== P A C K A G E S ==========\n\n____________________________________________________\n";
			...
			{	cin>>package;
				if (package=='A'||package=='a'){
					...
					strcpy(dest, "NEW YORK");amount=2340;rDiscountA=1260;rDest3=rDest3+4;
					voidPackages();
				}
